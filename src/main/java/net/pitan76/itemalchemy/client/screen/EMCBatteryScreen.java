...
public class EMCBatteryScreen extends CompatInventoryScreen<EMCBatteryScreenHandler> {
    public PlayerInventory playerInventory;

    EMCBatteryScreenHandler screenHandler;

    public EMCBatteryScreen(EMCBatteryScreenHandler handler, PlayerInventory inventory, Text title) {
