...
public abstract class OwnedBlockEntity extends EMCStorageBlockEntity {
    ...
    public OwnedBlockEntity(BlockEntityTypeWrapper type, TileCreateEvent event) {
        super(type, event);
    }

    public OwnedBlockEntity(BlockEntityTypeWrapper type, BlockPos pos, BlockState state) {
