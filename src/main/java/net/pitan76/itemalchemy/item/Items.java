...
public class Items {
    ...
    public static void init() {
        ...
        // Dark Matter Armor
        DARK_MATTER_HELMET = registry.registerItem(_id("dark_matter_helmet"), () -> new DarkMatterArmor(ArmorEquipmentType.HEAD, CompatibleItemSettings.of(_id("dark_matter_helmet")).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.HEAD)).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        DARK_MATTER_CHESTPLATE = registry.registerItem(_id("dark_matter_chestplate"), () -> new DarkMatterArmor(ArmorEquipmentType.CHEST, CompatibleItemSettings.of(_id("dark_matter_chestplate")).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.CHEST)).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        DARK_MATTER_LEGGINGS = registry.registerItem(_id("dark_matter_leggings"), () -> new DarkMatterArmor(ArmorEquipmentType.LEGS, CompatibleItemSettings.of(_id("dark_matter_leggings")).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.LEGS)).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        DARK_MATTER_BOOTS = registry.registerItem(_id("dark_matter_boots"), () -> new DarkMatterArmor(ArmorEquipmentType.FEET, CompatibleItemSettings.of(_id("dark_matter_boots")).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.FEET)).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));

        // Red Matter Armor
        RED_MATTER_HELMET = registry.registerItem(_id("red_matter_helmet"), () -> new RedMatterArmor(ArmorEquipmentType.HEAD, CompatibleItemSettings.of(_id("red_matter_helmet")).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.HEAD)).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        RED_MATTER_CHESTPLATE = registry.registerItem(_id("red_matter_chestplate"), () -> new RedMatterArmor(ArmorEquipmentType.CHEST, CompatibleItemSettings.of(_id("red_matter_chestplate")).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.CHEST)).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        RED_MATTER_LEGGINGS = registry.registerItem(_id("red_matter_leggings"), () -> new RedMatterArmor(ArmorEquipmentType.LEGS, CompatibleItemSettings.of(_id("red_matter_leggings")).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.LEGS)).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
        RED_MATTER_BOOTS = registry.registerItem(_id("red_matter_boots"), () -> new RedMatterArmor(ArmorEquipmentType.FEET, CompatibleItemSettings.of(_id("red_matter_boots")).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.FEET)).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1)));
