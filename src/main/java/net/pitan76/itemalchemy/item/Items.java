...
public class Items {
    ...
    public static void init() {
        ...
        // Dark Matter Armor
        DARK_MATTER_HELMET = registry.registerItem(_id("dark_matter_helmet"), () -> new DarkMatterArmor(ArmorEquipmentType.HEAD, CompatibleItemSettings.of(_id("dark_matter_helmet")).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.HEAD))));
        DARK_MATTER_CHESTPLATE = registry.registerItem(_id("dark_matter_chestplate"), () -> new DarkMatterArmor(ArmorEquipmentType.CHEST, CompatibleItemSettings.of(_id("dark_matter_chestplate")).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.CHEST))));
        DARK_MATTER_LEGGINGS = registry.registerItem(_id("dark_matter_leggings"), () -> new DarkMatterArmor(ArmorEquipmentType.LEGS, CompatibleItemSettings.of(_id("dark_matter_leggings")).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.LEGS))));
        DARK_MATTER_BOOTS = registry.registerItem(_id("dark_matter_boots"), () -> new DarkMatterArmor(ArmorEquipmentType.FEET, CompatibleItemSettings.of(_id("dark_matter_boots")).enchantable(15).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.DARK_MATTER.getDurability(ArmorEquipmentType.FEET))));

        // Red Matter Armor
        RED_MATTER_HELMET = registry.registerItem(_id("red_matter_helmet"), () -> new RedMatterArmor(ArmorEquipmentType.HEAD, CompatibleItemSettings.of(_id("red_matter_helmet")).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.HEAD))));
        RED_MATTER_CHESTPLATE = registry.registerItem(_id("red_matter_chestplate"), () -> new RedMatterArmor(ArmorEquipmentType.CHEST, CompatibleItemSettings.of(_id("red_matter_chestplate")).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.CHEST))));
        RED_MATTER_LEGGINGS = registry.registerItem(_id("red_matter_leggings"), () -> new RedMatterArmor(ArmorEquipmentType.LEGS, CompatibleItemSettings.of(_id("red_matter_leggings")).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.LEGS))));
        RED_MATTER_BOOTS = registry.registerItem(_id("red_matter_boots"), () -> new RedMatterArmor(ArmorEquipmentType.FEET, CompatibleItemSettings.of(_id("red_matter_boots")).enchantable(20).addGroup(ItemGroups.ITEM_ALCHEMY).maxCount(1).maxDamage(AlchemicalArmorMaterials.RED_MATTER.getDurability(ArmorEquipmentType.FEET))));
