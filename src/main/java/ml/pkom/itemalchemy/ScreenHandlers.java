...
public class ScreenHandlers {
    ...
    public static ScreenHandlerType<EMCCollectorScreenHandler> EMC_COLLECTOR = ScreenHandlerRegistry.registerSimple(ItemAlchemy.id("emc_collector"), EMCCollectorScreenHandler::new);
