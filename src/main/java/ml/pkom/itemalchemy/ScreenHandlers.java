...
public class ScreenHandlers {
    ...
    public static ScreenHandlerType<AlchemyChestScreenHandler> ALCHEMY_CHEST = ScreenHandlerRegistry.registerSimple(ItemAlchemy.id("alchemy_chest"), AlchemyChestScreenHandler::new);
