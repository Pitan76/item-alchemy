...
public class Red Matter Armour<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "red_matter armour"), "main");
	...
	public Red Matter Armour(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(45, 76).addBox(-4.0F, -7.0F, -5.0F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		...
		.texOffs(57, 2).addBox(-3.0F, -12.0F, -5.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(57, 2).addBox(2.0F, -12.0F, -5.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
