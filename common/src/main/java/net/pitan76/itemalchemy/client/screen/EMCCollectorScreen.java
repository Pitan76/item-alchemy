...
public class EMCCollectorScreen extends CompatInventoryScreen<EMCCollectorScreenHandler> {
    public PlayerInventory playerInventory;

    EMCCollectorScreenHandler screenHandler;

    public EMCCollectorScreen(EMCCollectorScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    public void drawForegroundOverride(DrawForegroundArgs args) {
        ...
        drawText(args.drawObjectDM, TextUtil.literal(String.format("%,d", emc)), 92, 32, 4210752);
    }
